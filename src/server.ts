...
app.get("/books", async (req: BooksGetRequest, res: BooksResponse) => {
    let result: Book[];
    try {
...
app.get("/authors", async (req: AuthorsGetRequest, res: AuthorsResponse) => {
    let result: Author[];
    try {
...
app.post("/books", async (req: BookRequest, res: BookResponse) => {
    let newBook: NewBook;
...
app.post("/authors", async (req: AuthorRequest, res: AuthorResponse) => {
...
app.delete("/authors/:id", async (req: DeleteRequest, res) => {
    try {
...
app.delete("/books/:id", async (req: DeleteRequest, res) => {
    try {
